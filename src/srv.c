...
void netbuf_add_32bitnum(unsigned char *buf, int buflen, int *offset,
                         unsigned int num)
{
...
void netbuf_get_32bitnum(unsigned char *buf, int buflen, int *offset,
                         unsigned int *num)
{
    unsigned char *start = buf + *offset;
    unsigned char *p = start;
...
void netbuf_add_16bitnum(unsigned char *buf, int buflen, int *offset,
                         unsigned short num)
{
    unsigned char *start = buf + *offset;
    unsigned char *p = start;
...
void netbuf_get_16bitnum(unsigned char *buf, int buflen, int *offset,
                         unsigned short *num)
{
    unsigned char *start = buf + *offset;
    unsigned char *p = start;
...
int netbuf_get_domain_name(unsigned char *buf, int buflen, int *offset,
                           char *namebuf,
                           int namebuflen)
{
    unsigned char *start = buf + *offset;
...
void netbuf_add_dnsquery_header(unsigned char *buf, int buflen, int *offset,
...
void netbuf_get_dnsquery_header(unsigned char *buf, int buflen, int *offset,
                                struct dnsquery_header *header)
{
    unsigned char *p;
...
void netbuf_add_dnsquery_question(unsigned char *buf, int buflen, int *offset,
...
void netbuf_get_dnsquery_question(unsigned char *buf, int buflen, int *offset,
                                  struct dnsquery_question *question)
{
...
void netbuf_get_dnsquery_srvrdata(unsigned char *buf, int buflen, int *offset,
...
void netbuf_get_dnsquery_resourcerecord(unsigned char *buf, int buflen, int *offset,
    ...
    if (!set) {
        ...
        if (numdnsservers) {
            ...
            for (i = 0; i < numdnsservers && insize <= 0; i++) {
                ...
                for (j = 0; j < 50; j++) {
                    insize = recvfrom(sock, (char *)buf, 65536, 0, (struct sockaddr *)&dnsaddr,
                                      &addrlen);
